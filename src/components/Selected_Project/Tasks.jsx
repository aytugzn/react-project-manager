...
export default function Tasks({ allTasks, handleClear, project, handlePopup, isTrue }) {
  return (
    <>
      <ul className="bg-stone-100 rounded py-6 px-4 flex flex-col gap-6 mb-4">
      ...
      <PopupModal color={"red"} isTrue={isTrue} handlePopup={handlePopup}>
